											...
											<div class="cards-carousel">
												<div class="mask">
													...
													<div class="bank ng-binding"
														style="background-image: url(../images/combo.png);">中国农业银行</div>
													<div class="details">
														<a>查看详情</a>
													</div>
												</div>
										...
										<li>
											<div class="cards-carousel">
												<div class="mask">
													...
													<div class="bac fn-left"></div>
													<div class="bank ng-binding"
														style="background-image: url(../images/combo1.png);">中国建设银行</div>
													<div class="details">
														<a>查看详情</a>
													</div>
												</div>
										...
										<li>
											<div class="cards-carousel">
												<div class="mask">
													...
													<div class="bac fn-left"></div>
													<div class="bank ng-binding"
														style="background-image: url(../images/combo2.png);">浦发银行</div>
													<div class="details">
														<a>查看详情</a>
													</div>
												</div>
										...
										<li>
											<div class="cards-carousel">
												<div class="mask">
													...
													<div class="bac fn-left"></div>
													<div class="bank ng-binding"
														style="background-image: url(../images/combo3.png);">中国光大银行</div>
													<div class="details">
														<a>查看详情</a>
													</div>
												</div>
								...
								$(document)
										.ready(
												function(ev) {
													...
													$(
															'.cards-details .close,.am-next,.am-prev,.am-control-nav li a')
															.on(
																	'click',
																	function(ev) {
																		$(
